...
foreach ($val as $document) {
		...
		$tempData[]=['id'=>$document['sl_no'],'name'=>$document['name'],'details'=>$document['comments'],'location'=>$document['location'],'date'=>$document['date_update'],'image'=>$document['image'],'status'=>$document['status']];
	}
