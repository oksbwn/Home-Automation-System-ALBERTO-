						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php
								...
								$m = new MongoClient();
								$db = $m->smart_home->phone_synced_contacts_list;
								...
								foreach ($val as $document) {
									...
									echo '<tr>
											...
											<td class="center">'.$document['person_name'].'</td>
											<td class="center">'.$document['contact_no'].'</td>
											<td class="center">'.$document['email_id'].'</td>
