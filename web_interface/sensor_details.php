	...
	<!-- start: Header -->
		...
		<div id="content" class="span10">
			<ul class="breadcrumb">
				...
				<li><a href="#">Sensor Details</a></li>
			</ul>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Sensor Details</h2>
						<div class="box-icon">
							...
							<?php
								...
								foreach ($val as $document) {	
									echo '<tr>
											...
											<td class="center">'.$document['sensor_id'].'</td>
											<td class="center">'.$document['board_id'].'</td>
											<td class="center">'.$document['sensor_type'].'</td>
