	...
	<!-- start: Header -->
		...
		<div id="content" class="span10">
			<ul class="breadcrumb">
				...
				<li><a href="#">New Audio Profile</a></li>
			</ul>
					...
					<div class="box-content">
						<form class="form-horizontal">
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="control-label" for="prependedInput">Sequence</label>
								<div class="controls">
								  <div class="input-prepend">
									<input id="sequence" size="16" type="text" value="">
								  </div>
								</div>
							  </div>							  
							  <div class="control-group">
								<label class="control-label" for="prependedInput">Input</label>
								<div class="controls">
								  <div class="input-prepend">
									<input id="input_devices" size="16" type="text" value="">
								  </div>
								</div>
							  </div>							 
							  <div class="control-group">
								<label class="control-label" for="prependedInput">Output</label>
								<div class="controls">
								  <div class="input-prepend">
									<input id="output_devices" size="16" type="text" value="">
								  </div>
								</div>
							  </div>
							  <div class="control-group">
							  ...
							  <div class="form-actions">
								<button type="submit" class="btn btn-primary" onClick="addAudioProfile();">ADD</button>
