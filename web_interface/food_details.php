			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Food Details</h2>
						<div class="box-icon">
							...
							<?php
								...
								foreach ($val as $document) {
									...
									echo '<tr>
											...
											<td class="center">'.$document['food'].'</td>
											<td class="center">'.$document['image'].'</td>
											<td class="center">'.$document['calorie'].'</td>
